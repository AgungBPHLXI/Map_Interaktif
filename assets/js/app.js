...
satelliteControl.onAdd = function(map){
    ...
    btn.onclick = function(e){
        ...
        if(!isSatellite){
            ...
            setTransparentMode();  // 🔥 Transparan saat satelit
...
function onLocationFound(e) {
    ...
    markerLokasi = L.marker(e.latlng).addTo(map)
        .bindPopup("📍 Anda berada di sini<br>Akurasi: " + Math.round(radius) + " meter")
        .openPopup();
...
var uploadLayer = L.geoJSON(null,{
